			...
			<div class="col-sm-9 col-md-10">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="icon glyphicon glyphicon-briefcase"></span>新建账户
					</div>
					<div class="panel-body">
						<form action="my" method="post" class="form-horizontal text-left"
							role="form">
							<input type="hidden" name="_method" value="PUT" /> <input
								type="hidden" name="id" value="${my.id}" />
							<div class="form-group">
								<label class="col-sm-3" for="title">*用户名</label>
								<div class="col-sm-6">
									<input class="form-control" type="text" name="nickName"
										value="${my.nickName}" readonly="readonly" />
								</div>
							</div>
							...
							<div class="form-group ${realName!=null?'has-error':''}">
								...
								<div class="col-sm-6">
									<input class="form-control" autocomplete="off" name="realName"
										type="text" value="${my.realName}" />
							...
							<div class="form-group ${password!=null?'has-error':''}">
								...
								<div class="col-sm-6">
									...
									<input style="margin-top: 5px;" class="form-control input-sm"
