...
import com.tongzhuogame.iblog.entity.Option;
import com.tongzhuogame.iblog.mapper.BaseMapper;
import com.tongzhuogame.iblog.mapper.OptionMapper;

@Service
public class OptionsService extends BaseService<Option> {
	...
	@Override
	protected BaseMapper<Option> getMapper() {
		return optionMapper;
	}
}
